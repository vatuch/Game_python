...
main_font = pygame.font.Font('D:/Работа/шрифты/gilroy/Gilroy-Regular.ttf', 30)
font = pygame.font.Font('D:/Работа/шрифты/dance/Dance.ttf', 50)
title_tetris = font.render('TETRIS', True, pygame.Color('#de5d83'))
title_score = font.render('score:', True, pygame.Color('#ffeeed'))

bg = pygame.image.load('C:/Users/vatuc/Downloads/rikonavt-oEWdQsbRVZk-unsplash.jpg').convert()
game_bg = pygame.image.load('C:/Users/vatuc/Downloads/drew-beamer-kUHfMW8awpE-unsplash.jpg').convert()
...
sound = pygame.mixer.Sound("C:/Users/vatuc/Downloads/875b8bd01943cfc.mp3")
sound_game_over = pygame.mixer.Sound("C:/Users/vatuc/Downloads/e0bdf44775a0d80.mp3")
